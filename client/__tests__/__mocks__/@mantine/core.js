...
ex.Card = React.forwardRef((props, ref) => {
  const { children, withBorder, ...rest } = props || {};
...
ex.Title = ({ order = 3, children, ...p }) =>
  React.createElement(`h${order}`, p, children);
ex.Kbd = passthroughFactory('kbd');

/* media */
ex.Image = ({ src, alt = '', ...p }) =>
  React.createElement('img', { src, alt, ...p });
ex.Video = passthroughFactory('video');
ex.Audio = passthroughFactory('audio');
ex.Avatar = ({ src, alt = 'avatar', ...p }) =>
  React.createElement('img', { src, alt, ...p });

/* feedback */
ex.Alert = ({ children, ...p }) =>
  React.createElement('div', { role: 'alert', ...p }, children);
...
ex.Badge = ({ onClick, children, ...p }) => {
  if (onClick) {
    return React.createElement(
      'button',
      { onClick, ...p },
      renderContent({ ...p, children }, children)
    );
  }
...
ex.Select = ({ label, data = [], value, onChange, disabled, ...p }) => {
  ...
  const el = React.createElement(
    'select',
    { id, value, onChange: handle, disabled, ...p },
    opts
  );
...
ex.MultiSelect = ({ label, data = [], value = [], onChange, disabled, ...p }) => {
  ...
  const el = React.createElement(
    'select',
    { id, multiple: true, value, onChange: handle, disabled, ...p },
    opts
  );
...
ex.FileInput = React.forwardRef(
  ({ label, placeholder, accept, onChange, ...p }, ref) => {
...
/* Popover always renders children */
ex.Popover = Object.assign(PassThrough, {
  Target: PassThrough,
  Dropdown: PassThrough,
});

/* Menu */
ex.Menu = Object.assign(PassThrough, {
  Target: PassThrough,
  Dropdown: PassThrough,
  ...
  Item: ({ children, onClick, color, leftSection, ...p }) =>
    React.createElement(
      'button',
...
/* table */
ex.Table = Object.assign(
  ({ children, ...p }) => React.createElement('table', p, children),
  {
...
/* Anchor */
ex.Anchor = ({ component: Comp = 'a', children, ...p }) =>
  React.createElement(Comp, p, children);
