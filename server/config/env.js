...
export const ENV = {
  ...
  GOOGLE_PLAY_RECONCILIATION_ENABLED:
    bool(process.env.GOOGLE_PLAY_RECONCILIATION_ENABLED, false),
  GOOGLE_PLAY_RECONCILIATION_INTERVAL_MS:
    num(process.env.GOOGLE_PLAY_RECONCILIATION_INTERVAL_MS, 3600000),
  GOOGLE_PLAY_RECONCILIATION_BATCH_SIZE:
    num(process.env.GOOGLE_PLAY_RECONCILIATION_BATCH_SIZE, 100),
  GOOGLE_PLAY_RECONCILIATION_STALE_MINUTES:
    num(process.env.GOOGLE_PLAY_RECONCILIATION_STALE_MINUTES, 360),
